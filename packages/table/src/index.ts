...
const TableModule: ModuleAdapter = { name: "table", functions: TableFunctions, functionMetadata: TableFunctionMetadata, moduleMetadata: TableModuleMetadata, global: false };
