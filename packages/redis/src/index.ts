...
const RedisModule: ModuleAdapter = { name: "redis", functions: RedisFunctions, functionMetadata: RedisFunctionMetadata as any, moduleMetadata: RedisModuleMetadata as any, global: false };
