...
const S3Module: ModuleAdapter = { name: "s3", functions: S3Functions, functionMetadata: S3FunctionMetadata as any, moduleMetadata: S3ModuleMetadata as any, global: false };
