...
const PromiseModule: ModuleAdapter = { name: "promise", functions: PromiseFunctions, functionMetadata: PromiseFunctionMetadata as any, moduleMetadata: PromiseModuleMetadata as any, global: false };
